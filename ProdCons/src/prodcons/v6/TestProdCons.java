...
public class TestProdCons {
    ...
    public static void main(String[] args) throws Exception {
        ...
        int nProduce = Integer.parseInt(properties.getProperty("nProduce"));

        IProdConsBuffer buffer = new ProdConsBuffer(bufSz,nProd);

        System.out.println("EXECUTION : V6 (Obj 6)");
        
        
        // producers
        for (int i = 0; i < nProd; i++) {	
        	new Producer(buffer, minProd, maxProd, prodTime,nProduce).start(); 
