...
public class TestProdCons {
    ...
    public static void main(String[] args) throws Exception {
        ...
        int kConsume = Integer.parseInt(properties.getProperty("kConsume")); // Obj 5

        IProdConsBuffer buffer = new ProdConsBuffer(bufSz,nProd);

        System.out.println("EXECUTION : V5 (Obj 5)");
     ...
     for (int i = 0; i < nCons; i++) {
         threads.add(new Consumer(buffer, consTime,kConsume));
     }
